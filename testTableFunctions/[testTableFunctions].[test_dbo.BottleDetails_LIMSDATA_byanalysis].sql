CREATE PROCEDURE testTableFunctions.[test_dbo.BottleDetails_LIMSDATA_byanalysis]
AS
BEGIN
	...
	DECLARE @analysis VARCHAR(12);	SET @analysis = '082923143632';
	...
	INSERT INTO actual SELECT * FROM [dbo].[BottleDetails_LIMSDATA_byanalysis](@analysis);
