ALTER PROCEDURE testTableFunctions.[test_dbo.SEQUENCE_DATA_STDSAMPLES_NewCal_REOPEN]
AS
BEGIN
	...
	INSERT INTO actual SELECT * FROM [dbo].[SEQUENCE_DATA_STDSAMPLES_NewCal_REOPEN](@analysis);
