CREATE PROCEDURE testTableFunctions.[test_dbo.SEQUENCE_LASTCAL_ADDITION_2]
AS
BEGIN
	IF OBJECT_ID('expected') IS NOT NULL DROP TABLE expected;
	IF OBJECT_ID('actual') IS NOT NULL DROP TABLE actual;

	DECLARE @userdevice	VARCHAR(4);		SET @userdevice = '0325';
	...
	INSERT INTO actual SELECT * FROM [dbo].[SEQUENCE_LASTCAL_ADDITION](@userdevice, @sampletype, @calId);

	INSERT INTO expected (Analysis
							,SequenceId
							,SampleType
							,Calibration
							,[DateTime]) VALUES ('analysisID'
							,'imasequenceID'
							,'Testing'
							,'Testing_Cal'
							,'08/31/2023 11:42:34');
