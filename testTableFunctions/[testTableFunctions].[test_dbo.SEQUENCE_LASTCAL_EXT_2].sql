CREATE PROCEDURE testTableFunctions.[test_dbo.SEQUENCE_LASTCAL_EXT_2]
AS
BEGIN
	...
	INSERT INTO actual SELECT * FROM [dbo].[SEQUENCE_LASTCAL_EXT_2](@userdevice, @analysis, @calId);
