ALTER PROCEDURE testTableFunctions.[test_dbo.SEQUENCE_DATA_STD_VIEW]
AS
BEGIN
	...
	CREATE TABLE expected (TraxId	VARCHAR(30)
	...
	CREATE TABLE actual (TraxId	VARCHAR(30)
				,SampleType			VARCHAR(50)
				,[Priority]			TINYINT
				,Rack				VARCHAR(2)
				,Vial				VARCHAR(2)
	...
	INSERT INTO actual SELECT * FROM [dbo].[SEQUENCE_DATA_STD_VIEW](@analysis);
